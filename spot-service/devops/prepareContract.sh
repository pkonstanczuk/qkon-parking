...
java -jar "${DEVOPS_PATH}"/../../shared/openapi-generator-cli.jar generate -g python-flask -i "${DEVOPS_PATH}"/../src/main/resources/contract.yaml -o "${DEVOPS_PATH}"/../build/ --additional-properties=useNose=true,packageName=contract,generateSourceCodeOnly=true
