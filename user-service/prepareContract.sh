...
cp "${PARENT_PATH}"/build/contract/openapi/openapi.yaml "${PARENT_PATH}"/docs/${CONTRACT_FILE_NAME}
echo "Install shared libs"
...
# to this one
datamodel-codegen --input ./docs/${CONTRACT_FILE_NAME} --output src/contract/models.py
